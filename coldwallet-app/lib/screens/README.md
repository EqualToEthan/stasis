...
| home_screen.dart | HomeScreen | 首页，多链地址下拉切换、钱包选择器、扫码签名和文件导入入口，所有链显示地址二维码按钮（Cardano 链额外显示 stake address 和合并 QR），QrImageView 需用 SizedBox 包裹以兼容 AlertDialog 的 IntrinsicWidth |
...
| 修改地址二维码展示逻辑 | home_screen.dart — Cardano 链修改 _showCombinedQrDialog，EVM 链修改 _showAddressQrDialog |
