...
- [coldwallet-watch/lib/models/certificate.dart](file://coldwallet-watch/lib/models/certificate.dart)
...
- 添加 CardanoAdapter 中质押交易签名的实现细节
...
E["services/adapters/cardano_adapter.dart"]
end
subgraph "热端(coldwallet-watch)"
F["models/watch_wallet.dart"]
G["models/asset_balance.dart"]
H["models/cold_export.dart"]
I["models/cold_import.dart"]
J["models/certificate.dart"]
end
B --> |"导出未签名交易(含证书)"| H
I --> |"导入已签名交易"| C
F --> |"只读地址/网络元数据"| A
...
**图表来源**
- [coldwallet-app/lib/models/cold_export.dart:1-137](file://coldwallet-app/lib/models/cold_export.dart#L1-L137)
...
participant 适配器 as "CardanoAdapter"
...
alt 质押交易
冷端->>适配器 : "调用 signTransaction"
适配器->>适配器 : "_signStakingTransaction()"
适配器->>适配器 : "构建 TxSigningBundle"
适配器->>适配器 : "自动检测证书类型并添加 stake witness"
end
冷端->>冷端 : "支付密钥签名"
...
**章节来源**
- [coldwallet-app/lib/models/cold_export.dart:69-105](file://coldwallet-app/lib/models/cold_export.dart#L69-L105)
- [coldwallet-watch/lib/models/cold_export.dart:69-106](file://coldwallet-watch/lib/models/cold_export.dart#L69-L106)
...
**章节来源**
- [coldwallet-app/lib/models/cold_export.dart:107-136](file://coldwallet-app/lib/models/cold_export.dart#L107-L136)
- [coldwallet-watch/lib/models/cold_export.dart:108-137](file://coldwallet-watch/lib/models/cold_export.dart#L108-L137)
...
### CardanoAdapter（质押交易签名适配器）
**新增** 处理 Cardano 质押交易的签名逻辑。

- 职责：封装 Cardano 链特有的地址派生、交易解析和离线签名逻辑，特别支持质押交易。
- 关键方法
  - signTransaction：根据交易类型选择普通签名或质押交易签名。
  - _signStakingTransaction：处理包含证书或提款的复杂交易。
- 质押交易处理
  - 检测 certificates 或 withdrawals 字段。
  - 构建 TxSigningBundle 让 SDK 自动添加 stake key witness。
  - 支持 stake registration、delegation、deregistration 三种证书类型。
- 复杂度
  - 普通交易：O(1)
  - 质押交易：O(n)，n 为证书数量

**章节来源**
- [coldwallet-app/lib/services/adapters/cardano_adapter.dart:19-147](file://coldwallet-app/lib/services/adapters/cardano_adapter.dart#L19-L147)
...
- **CardanoAdapter 集成了 Certificate 模型，处理质押交易的复杂签名逻辑**。
- 整体耦合度低，内聚度高，适合分端迭代。
...
WW["热端 WatchWallet"]
AB["热端 AssetBalance"]
CERT_WATCH["热端 Certificate"] --> CE_watch
```
...
- [coldwallet-watch/lib/models/asset_balance.dart:1-63](file://coldwallet-watch/lib/models/asset_balance.dart#L1-L63)
- [coldwallet-app/lib/models/certificate.dart:1-48](file://coldwallet-app/lib/models/certificate.dart#L1-L48)
- [coldwallet-watch/lib/models/certificate.dart:1-43](file://coldwallet-watch/lib/models/certificate.dart#L1-L43)
- [coldwallet-app/lib/services/adapters/cardano_adapter.dart:1-147](file://coldwallet-app/lib/services/adapters/cardano_adapter.dart#L1-L147)
...
- **质押交易相关错误**
  ...
  - **质押交易签名失败：检查 CardanoAdapter 是否正确识别证书类型并构建 TxSigningBundle**。

**章节来源**
- [coldwallet-app/lib/models/cold_export.dart:35-66](file://coldwallet-app/lib/models/cold_export.dart#L35-L66)
- [coldwallet-watch/lib/models/cold_export.dart:35-66](file://coldwallet-watch/lib/models/cold_export.dart#L35-L66)
...
- [coldwallet-app/lib/services/adapters/cardano_adapter.dart:57-75](file://coldwallet-app/lib/services/adapters/cardano_adapter.dart#L57-L75)
...
- [coldwallet-watch/lib/models/cold_import.dart:18-34](file://coldwallet-watch/lib/models/cold_import.dart#L18-L34)
- [coldwallet-app/lib/models/cold_import.dart:18-34](file://coldwallet-app/lib/models/cold_import.dart#L18-L34)
- [coldwallet-app/lib/models/certificate.dart:28-46](file://coldwallet-app/lib/models/certificate.dart#L28-L46)
...
- 冷端解析并签名
  ...
  - **如果存在质押相关信息，调用 CardanoAdapter.signTransaction 处理质押交易签名**。
...
Confirm --> Sign["调用 CardanoAdapter.signTransaction"]
Sign --> StakeCheck{"是否需要 stake witness?"}
StakeCheck --> |否| Import["封装为 ColdImport"]
StakeCheck --> |是| Bundle["构建 TxSigningBundle 并签名"]
Bundle --> Import
